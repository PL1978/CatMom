...
const uint8_t OPEN_ANGLE = 35;
const uint8_t CLOSE_ANGLE = 16;
...
void flashLed(bool currentLedState) {
  for (uint8_t i = 0; i < 5; i++) {
    digitalWrite(ERROR_LED_PIN, !currentLedState);
    delay(600);
    digitalWrite(ERROR_LED_PIN, currentLedState);
    delay(600);
  }
...
void signalReady() {
  ...
  flashLed(digitalRead(ERROR_LED_PIN));
}
